...
<body class="box"onsubmit="return false">
    <div class="cards" id="form1">
        <form  method="post">
            ...
            <div>
                <h2>Endereço:</h2>
                <input type="text" name="Endereço" id="endereco" class="Caixa-Texto-Endereco" required />
            </div>
            <div class="row">
                <div class="column">
                    <h2>Número:</h2>
                    <input type="text" name="Número" id="numero" class="Caixa-Texto-Numero-Casa"
            ...
            <div>
                <h2>Cliente:</h2>
                <input type="text" name="Nome" id="cliente" class="Caixa-Texto-Cliente" required />
            </div>
            <div class="row">
                <div class="column">
                    <h2>Telefone (opcional):</h2>
                    <input type="text" name="Telefone" id="telefone2" class="Caixa-Texto-Telefone"
                        placeholder="(DDD)0000-0000" style="margin: auto;"
                        onkeypress="$(this).mask('(00)00000-0000')" />
                </div>
                <div class="columnCpfCnpj">
                    <h2>CPF ou CNPJ(opicional):</h2>
                    <input type="text" name="CpfCnpj" id="CpfCnpj2" class="Caixa-Texto-CPF-CNPJ2"
            ...
            <div>
                <h2>Obs.: (opicional)</h2>
                <input type="text" name="Nome" id="obs" class="Caixa-Texto-Observacao" />
            </div>
            <div>
            ...
            <div>
                ...
                <textarea name="Servico" id="servico" cols="30" rows="10" placeholder="Descreva o serviço que será realizado"
                    class="Caixa-Texto-Servico" required></textarea>
            </div>
            <div class="row">
                <div class="column">
                    <h2>Data:</h2>
                    <input type="text" id="data" class="Caixa-Data" onkeypress="$(this).mask('00/00/0000') " required>
                </div>

                <div class="column">
                    <h2>Hora:</h2>
                    <input type="text" id="hora" class="Caixa-Hora" onkeypress="$(this).mask('00:00')" required>
                    <sub>Somente os números</sub>
                </div>
            </div>
            <br>
            <div>
                <button class="Botao-GerarOS" onclick="resultado()" >
